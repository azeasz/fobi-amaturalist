        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <UnderDevelopmentPage 
              title="Spesies" 
              description="Halaman ini akan menampilkan data spesies yang telah Anda amati. Kami sedang menyiapkan fitur untuk melihat dan menganalisis spesies yang telah Anda temukan."
            />
          </div>
        </div>
      </div>
